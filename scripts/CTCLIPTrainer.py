...
class CTClipTrainer(nn.Module):
    def __init__(
        ...
        *,
        ...
        print("data_train is", data_train, "reports_file_train is ", reports_file_train)
        self.ds = CTReportDataset(data_folder=data_train, csv_file=reports_file_train)
        print("data_valid is", data_valid, "reports_file_valid is ", reports_file_valid)
...
#         print("self.is_main is", self.is_main)
        ...
        if self.is_main and not (steps % self.save_results_every):
            with torch.no_grad():
                ...
                for model, filename in models_to_evaluate:
                    ...
                    for i in range(10):
                        print("test")
#                         print(len(self.valid_dl_iter))
#                         for data in self.valid_dl_iter:
#                             print(data)
#                         input()
